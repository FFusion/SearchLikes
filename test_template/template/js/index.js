...
$(function() {
  ...
  rotator = function() {
    if (!onePause) {
      return slideTime = setTimeout(function() {
        return animSlide('next');
      }, dTimeOut);
    }
  };
