...
'use strict';
ProcessingWallModule.controller('ProcessingWallController', function($scope, $stateParams, $location, $timeout, RestModel, Notification, Loader, params, currentUser, friends) {
  $scope.params = params;
  $scope.window = window;
  $scope.loading = false;
  $scope.isLikes = [];
