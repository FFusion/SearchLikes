...
#        url;
    ...
    _getLinkUser: (id, params) ->
        #запрос на users.get
        url = vk.api + '/method/users.get?user_id=' + id + '&access_token=' + params.access_token + '&v=5.8&fields=sex,bdate,city,country,photo_200_orig,online,contacts,status,followers_count,common_count,counters&callback=JSON_CALLBACK'
        url;
